package com.test.common.persistence.dao;
...
public interface CrudDao<T,PK>  extends BaseDao {
     ...
     * @param rankType                 
     * */
    public List<T> findLike(@Param("entity") T entity, @Param("pageNo") int pageNo, @Param("pageSize") int pageSize, @Param("rankAttr") String rankAttr, @Param("rankAttrType") String rankType);
     ...
     * @throws Exception
     */
    public Timestamp getSysDate(@Param("name") String name)  throws Exception;
