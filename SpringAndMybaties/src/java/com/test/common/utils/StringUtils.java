...
//    }
     ...
     * @return
     */
    public static String abbrForUtf8(String str, int length) {
        if (str == null) {
            return "";
        }
        try {
     ...
     * 将字符串数组按指定格式合并
     */
    public static final String connectStrArray(String[] strs, String splitFlag) {
    ...
    /**
     * 将按下划线分割字符串按照驼峰法命名,首字母小写
     */
    public static final String underlineToCamelWithFirstLow(String param) {
        if (StringUtils.isEmpty(param)) {
            return "";
        }
    ...
    public static  String getFileName(String fileName) throws Exception{
        if (StringUtils.isNotBlank(fileName)) {
            ...
            String[] tmp = StringUtils.splitByWholeSeparator(fileName, "/");
     ...
     * 获取上发给集团的合同文件名称
     */
    public static  String getAttName(String fileName) throws Exception{
        try {
            if(StringUtils.isBlank(fileName)){
                return "Bboss_210_Attachment_"+System.currentTimeMillis();
            }
            String extension = getExtension(fileName);
            SimpleDateFormat dateformat1 = new SimpleDateFormat("yyyyMMddHHmmssSSS");
            Timestamp timestamp = new Timestamp(System.currentTimeMillis());
            String upDate = dateformat1.format(timestamp);
            return "Bboss_210_Attachment_" + upDate+"."+extension;
        } catch (Exception e) {
