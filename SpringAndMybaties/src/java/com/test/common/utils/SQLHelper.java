...
import com.test.common.persistence.annotation.Table;
        ...
        if(clazz.isAnnotationPresent((P_TABLE))){
            ...
            if(StringUtils.isNotEmpty(platTable.value())){
                tableName = platTable.value()
                        .replace(Constants.SplitTable.splitTableStartFlag,"")
                        .replace(Constants.SplitTable.splitTableEndFlag,"");
            }else{
...
//            tableName = Constants.SplitTable.splitTableStartFlag + tableName+ Constants.SplitTable.splitTableEndFlag;
//        }
        return tableName;
    }
